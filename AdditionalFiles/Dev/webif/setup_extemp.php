...
$query = sprintf("SELECT * FROM extemperature;");
		    			...
		    			<div class="col-sm-12">
		    		  	<div class="hpanel3">
		    		  	  <div class="panel-body" style="text-align:left; background:#F1F3F6;border:none;">
		    				  	<legend>USB External Temperature Sensor</legend> 
		              		...
		              		<div class="col-sm-2">
		              			<label class="col-sm-1 control-label" style="text-align:left">
		              				<div id="tempc" style="color:blue"><?php echo $tempc; ?></div> 
		              				</label>
		              		</div>
		              	</div>
		              		...
		              		<div class="col-sm-2">
		              			<label class="col-sm-1 control-label" style="text-align:left">
		              				<div id="tempf" style="color:green"><?php echo $tempf; ?></div> 
		              				</label>
		              		</div>
		              	</div>
		    				  	
		    				  	<div class="form-group"><label class="col-sm-1 control-label" style="text-align:left; min-width:120px; max-width:120px">Adjustment:</label>
		              		<div class="col-sm-4" style="min-width:120px; max-width:120px">
		              			<input type="text" class="form-control" name='adj' value='<?php echo $adj; ?>' onMouseOver="mouse_move(&#039;sd_extemp_cal&#039;);" onMouseOut="mouse_move();" required />
		              		</div>
		              	</div>
		    				  	
		    				  	<div class="form-group"><label class="col-sm-1 control-label" style="text-align:left; min-width:120px; max-width:120px">Notes:</label>
		              		<div class="col-sm-4" style="min-width:300px; max-width:300px">
		              			<textarea  rows="3" cols="48" class="form-control" name='notes' required><?php echo $notes; ?></textarea>
		              		</div>
		              	</div>
		              	
		    				  	<div class="form-group">	
		    				  		<div class="col-sm-2" style="text-align:left; min-width:250px; max-width:250px">
		    				  	...
		    				  	<div class="form-group">
		        					<div class="col-sm-12">
		        						...
		        						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		        						<button name="reset_btn" class="btn btn-danger" type="submit" onMouseOver="mouse_move(&#039;sd_extemp_reset&#039;);" onMouseOut="mouse_move();" formnovalidate><i class="fa fa-exclamation"></i> Reset</button>
		        					</div>
		        				</div>
		    				   					...
		    				   					<td>
		    				   						...
		    				   						<div class="table-responsive">
		    				   							<table class="table table-condensed table-hover">
		    				   									...
		    				   									<td>
		              										<input style="max-width:30%;" type="text" class="form-control" name='hi_t' value='<?php $hi_t = sprintf("%.4f",$hi_t); echo $hi_t; ?>' onMouseOver="mouse_move(&#039;thimax&#039;);" onMouseOut="mouse_move();" required />		
		    				   									</td>
		    				   								</tr>
		    				   								<tr>
																		<td style="text-align:right;vertical-align:middle">
		    				   									...
		    				   									<td>
		              										<input style="max-width:30%;" type="text" class="form-control" name='hi_t_min' value='<?php $hi_t_min = sprintf("%.4f",$hi_t_min); echo $hi_t_min; ?>' onMouseOver="mouse_move(&#039;thimin&#039;);" onMouseOut="mouse_move();" required />		
		    				   									</td>
		    				   								</tr>
		    				   								<tr>
		    				   									<td style="text-align:right;vertical-align:middle">
		    				   					...
		    				   					<td>
		    				   						...
		    				   						<div class="table-responsive">
		    				   							<table class="table table-condensed table-hover">
		    				   									...
		    				   									<td>
		              										<input style="max-width:30%;" type="text" class="form-control" name='lo_t_max' value='<?php $lo_t_max = sprintf("%.4f",$lo_t_max); echo $lo_t_max; ?>' onMouseOver="mouse_move(&#039;tlomin&#039;);" onMouseOut="mouse_move();" required />		
		    				   									</td>
		    				   								</tr>
		    				   								<tr>
																		<td style="text-align:right;vertical-align:middle">
		    				   									...
		    				   									<td>
		              										<input style="max-width:30%;" type="text" class="form-control" name='lo_t' value='<?php $lo_t = sprintf("%.4f",$lo_t); echo $lo_t; ?>' onMouseOver="mouse_move(&#039;tlomax&#039;);" onMouseOut="mouse_move();" required />		
...
<script language="javascript" type="text/javascript">
	function display_temps()
	{
     	...
     	$.getJSON('extemp_server.php?element=temps&rand=' + myRandom,
     	function(data)
     	{
     		$.each (data.temp, function (k, v) { $('#' + k).text (v); });
