function StateHandler(autoPcShutdownState) {
    ...
    function isPcOnButtonNotTriggerable() {var onState = _pingState; return (_isAutoPcShutdownOn || _hasPcBeenTriggered || _isPcRebooting || _isSystemPowerCycling || _isPcOn);}
