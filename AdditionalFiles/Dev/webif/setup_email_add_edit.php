...
{	
	...
	if(isset($_POST['company_notes']))
	{
		$company_notes = "CHECKED";
	}
	else
	{
		$company_notes = " ";
	...
	if($action == "add")
	{
		$query = sprintf("INSERT INTO alerts VALUES (NULL, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');", $type, $name, $desc, $to, $subject, $smtp, $body, $from, $auth_check, $username, $password, $ssl, $tls, $port, $company_name, $company_phone, $company_notes);
	...
	if($action == "edit")
	{
		$query = sprintf("UPDATE alerts SET name='%s', desc='%s', v1='%s', v2='%s', v3='%s', v4='%s', v5='%s', v6='%s', v7='%s', v8='%s', v9='%s', v10='%s', port='%s', company_name='%s', company_phone='%s', company_notes='%s' WHERE id='%d';",$name, $desc, $to, $subject, $smtp, $body, $from, $auth_check, $username, $password, $ssl, $tls, $port, $company_name, $company_phone, $company_notes, $id);
		//echo $query;
		$result  = $dbh->exec($query);
		header("Location: setup_notifications.php?alert_flag=1");
	}
    	...
    	<div class="col-sm-12">
      	<div class="hpanel4">
      		<div class="panel-body" style="max-width:600px">
      	  	<form name='EmailAlerts' action='setup_email_add_edit.php' method='post' class="form-horizontal"">  	
      	    	<fieldset>
      	    		<legend><img src="images/btn_email_add_bg.gif"> <?php echo $title; ?></legend> 
      	    		
      	    		<div class="form-group"><label class="col-sm-3 control-label" style="text-align:left; max-width:140px; min-width:140px">Alert Name:</label>
              		...
              		<div class="col-sm-12 input-group" style="max-width:350px">
              			...
              			<textarea  rows="2" cols="50" class="form-control" name='body' required><?php echo $body; ?></textarea>
								...
								<div class="form-group"><label class="col-sm-3 control-label" style="text-align:left; max-width:140px; min-width:140px">Add <a href="setup_company.php"><u class="dotted">Company:</u></a></label>
              		<div class="col-sm-12 checkbox checkbox-success" style="max-width:350px; min-width:350px">
              			<input type='checkbox' id='company_name' name='company_name' <?php echo $company_name; ?> />
    		            <label for='company_name'><strong>Name</strong></label>
    		            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    		            <input type='checkbox' id='company_phone' name='company_phone' <?php echo $company_phone; ?> />
    		            <label for='company_phone'><strong>Phone</strong></label>
    		            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    		            <input type='checkbox' id='company_notes' name='company_notes' <?php echo $company_notes; ?> />
    		            <label for='company_notes'><strong>Notes</strong></label>
              		</div>
              	</div>
              		...
              		<div class="col-sm-12 checkbox checkbox-success" style="max-width:250px; min-width:250px">
              		...
              		<div class="col-sm-12 input-group" style="max-width:350px">
              				...
              				?>
								...
								<div class="form-group"><label class="col-sm-3 control-label" style="text-align:left; max-width:140px; min-width:140px"></label>
              		<div class="col-sm-12 radio radio-success" style="max-width:150px; min-width:150px">
              				<?php
    				  					if($auth_check == "CHECKED")
    				  					{
