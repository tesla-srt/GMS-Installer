<?php 
    ...
    class InputHandler
    {
        ...
        const selSysVoltage = "selSysVoltage";
        ...
        public static function processServerSettingsFormSubmission($dbh, $fanOnTemp, $fanOffTemp)
        {
            if(isset($_POST[InputHandler::btnServerSettingsUpdate]))
            {
                ...
                InputHandler::setSystemVoltage($dbh);
                InputHandler::reloadSite();
                restartSomeServices();
        ...
        private static function setSystemVoltage($dbh) {
            $sysVoltInput = $_POST[InputHandler::selSysVoltage];
            $query = sprintf("UPDATE voltmeters SET lo_t='%2.2f', lo_t_max='%2.2f' WHERE id='1';", floatval($sysVoltInput - 0.1), floatval($sysVoltInput));
